...
public class SiteOrderService {
    ...
    public SiteOrderService(SiteOrderRepository siteOrderRepo,
                            FinalOrderRepository finalOrderRepo,
                            SubBatchRepository subBatchRepo,
                            OrderOptimizationService optimService,
                            SiteRepository siteRepo) {
        this.siteOrderRepo = siteOrderRepo != null ? siteOrderRepo : new SiteOrderRepository();
        this.finalOrderRepo = finalOrderRepo != null ? finalOrderRepo : new FinalOrderRepository();
        this.subBatchRepo = subBatchRepo != null ? subBatchRepo : new SubBatchRepository();
        this.optimService = optimService != null ? optimService : new OrderOptimizationService();
        this.siteRepo = siteRepo != null ? siteRepo : new SiteRepository();
    }
